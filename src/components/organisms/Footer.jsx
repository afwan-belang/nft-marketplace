        ...
        <div className="flex flex-col lg:flex-row justify-between gap-12 lg:gap-8">
          ...
          <div className="w-full lg:w-1/3 flex flex-col gap-6">
            ...
            <div className="flex items-center gap-4 mt-2">
              {[Twitter, Instagram, Dribbble, Github].map((Icon, idx) => (
                <a key={idx} href="#" className="w-10 h-10 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-gray-400 hover:text-white hover:bg-primary transition-all duration-300 hover:shadow-[0_0_15px_rgba(138,43,226,0.5)]">
                  <Icon size={18} />
                </a>
              ))}
            </div>
